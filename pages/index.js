          ...
          <div className="container mb-5">
            <div className="row mt-5">
              ...
              <div className="col-md-5">
                ...
                <div>
                  <Button variant="primary" size="lg" className={styles.cvbutton}>
                    Create CV
                  </Button>
                </div>
                  <span className={styles.cvtext}>Use our Free CV Template to create a professional looking CV quickly</span>
              </div>
            </div>
          </div>
        </section>
