          ...
          <div className={styles.body_image}>
            <div className="container">
              <div className={styles.body_image_text}>
                <h1>
                  Hire <span className={styles.students}>Students</span> for
                  your company
                </h1>
              </div>
            </div>
          ...
          <div className="container">
            <div className={styles.finding_young_talent}>
              ...
              <p className={styles.section_text}>
                ...
                business quickly and effectively. Are you interested in
                publishing apprenticeships for your growing company? Or do you
                need to hire employees fast for an upcoming weekend shift? Post
                a vacancy today and receive applications straight to your inbox.
                Are you a new customer? Take advantage of our free job
                advertising offer today and contact us on info@stuwok.com to
                find out the best way to advertise your job.
              </p>
              ...
              <div class=" container">
                <div className={styles.finding_young_talent}>
                  ...
                  <p class="section-text">
                    We get it. Looking for employees can be stressful. It takes
                    up your time, effort and most importantly, money. That’s why
                    at StudentJob we are offering first-time clients the
                    opportunity to post a job advert for free. No obligations.
                    If you take advantage of this offer you will still benefit
                    from our tailored Account Manager service and assistance
                    every step of the way. If you are happy after one month,
                    let's discuss how we can maximise your reach and enhance
                    your job posting experience. Otherwise, you are free to walk
                    away. Place your job advert for free and let us connect
                    students to you.
                  </p>
                  ...
                  >
                    <div className={styles.forMobile}>
                      ...
                      >
                        ...
                        <div>
                          <small className="my-0 font-weight-bold">
                            30 Days
                          </small>
                        </div>
                      </div>
                      ...
                      <span
                        ...
                        style={{ padding: '15px' }}
                      >
                        With our HR support, we provide all the neccessary tools
                        to enable you employ the best fit for your organization
                      </span>
                      <div className="card-body">
                        <ul className="list-unstyled mt-3 mb-4">
                          <li>10 users included</li>
              ...
              <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="card-deck">
                        <div class="card card-images">
                          <img
                            src="https://res.cloudinary.com/davak/image/upload/v1598219360/Rectangle_60_iktzgn.png"
                            alt=""
                          />
                          <div class="card-body">
                            <h3>Philip Ofei</h3>
                    ...
                    <div class="col-md-4">
                      <div class="card-deck">
                        <div class="card card-images">
                          <img
                            src="https://res.cloudinary.com/davak/image/upload/v1598219361/Rectangle_60-1_kw9spi.png"
                            alt=""
                          />
                          <div class="card-body">
                            <h3>Philip Ofei</h3>
                    ...
                    <div class="col-md-4">
                      <div class="card-deck">
                        <div class="card card-images">
                          <img
                            src="https://res.cloudinary.com/davak/image/upload/v1598219361/Rectangle_60-2_ilahnt.png"
                            alt=""
                          />
                          <div class="card-body">
                            <h3>Philip Ofei</h3>
                ...
                <div class="col-md-4 Need-help">
                  <div class="card-body">
                    ...
                    <button
                      class="buttons btn btn-primary font-weight-bold"
